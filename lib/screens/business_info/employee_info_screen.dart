...
class _EmployeeInfoScreenState extends State<EmployeeInfoScreen> {
  ...
  final Map<String, String> info = {"Funcionarios": "15"};
  ...
  Widget _buildViewInformation() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildInfoRow("Número de Funcionários:", info["Funcionarios"]!,
              Icons.co_present),
        ],
      ),
    );
      ...
      child: Column(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildTextField(title: "Número de Funcionários", value: "0"),
            ],
          ),
